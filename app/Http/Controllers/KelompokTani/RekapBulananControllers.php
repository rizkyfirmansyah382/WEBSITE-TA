...
class RekapBulananControllers extends Controller
{
    function index()
    {
        ...
        return view('kelompoktani.rekappanenbulanan.index', compact('result', 'bulanpanen'));
    }
    ...
    function checkRekap($id_tanggal_panen)
    {
        ...
        return view('kelompoktani.rekappanenbulanan.checklaporan', compact('kelompokData', 'id_tanggal_panen'));
    }
    ...
    function checkData($id_tanggal_panen, $id_tanggal_panen_revisi)
    {
        ...
        return view('kelompoktani.rekappanenbulanan.checkdata', compact('kelompokData', 'id_tanggal_panen', 'id_tanggal_panen_revisi'));
    }
    ...
    function update($id_data_panen_kelompok, $id_tanggal_panen, $id_tanggal_panen_revisi)
    {
        ...
        return view('kelompoktani.rekappanenbulanan.update', compact('tonase', 'id_tanggal_panen', 'id_tanggal_panen_revisi'));
    }
    ...
    function updateData(Request $request, $id_data_panen_kelompok, $id_tanggal_panen, $id_tanggal_panen_revisi)
    {
        ...
        return redirect("/rekap-bulanan/checkData/{$id_tanggal_panen}/{$id_tanggal_panen_revisi}")->with('success', 'Update data panen anggota berhasil diperbarui.');
    }
}
