...
@section('content')
    <div class="container-fluid">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-2">
            <h1 class="h3 mb-0" style="color: black">Tambah Data Surat Perintah Bongkar</h1>
        </div>
        ...
        <div class="card w-100 mb-4" style="background-color: #D9D9D9">
            <div class="card-body">
                <form action="/data-spb/createData/{{ $id_tanggal_panen }}" method="POST">
                    @csrf
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="custom-select" name="id_sopir">
                            ...
                            @foreach ($sopir as $item)
                                <option value="{{ $item->id_sopir }}">{{ $item->nama_sopir }}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="mb-3">
                        ...
                        <select class="custom-select" name="id_kendaraan">
                            ...
                            @foreach ($kendaraan as $item)
                                <option value="{{ $item->id_kendaraan }}">{{ $item->no_polisi }}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="mb-3">
                        <label class="form-label">Nomor Surat Perintah Bongkar</label>
                        <input type="text" class="form-control" name="no_spb">
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="tujuan_pks">
                    </div>
