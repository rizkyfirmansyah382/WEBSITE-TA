...
<head>
    ...
    <title>SIKETAS - Kelompok Tani</title>

    @include('mandor.temp_mandor.css')
...
<body id="page-top"
    ...
    <div id="wrapper">
        ...
        <!-- Sidebar -->
        @include('mandor.temp_mandor.sidebar')
        <!-- End of Sidebar -->
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <!-- Topbar -->
                @include('mandor.temp_mandor.header')
                <!-- End of Topbar -->
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a class="btn btn-primary" href="/logout-kedua">Logout</a>
                </div>
            </div>
        </div>
    </div>

    @include('kelompoktani.temp_kelompok.javascript')
</body>
