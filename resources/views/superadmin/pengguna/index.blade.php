...
@section('content')
    <div class="container-fluid">
        <div class="d-sm-flex align-items-center justify-content-between text-light">
            ...
            <a href="/user-super-admin/create" class="btn btn-primary btn-sm mb-4">Tambah Data</a>
        </div>
                    ...
                    <tbody>
                        ...
                        @foreach ($user as $item)
                            <tr>
                                ...
                                <td>{{ $item->role }}</td>
                                <td>
                                    <a href="/user-super-admin/{{ $item->id }}/update"
                                        class="btn btn-warning my-1 btn-sm">
                                        <i class="far fa-edit"></i>
                                    </a>
                                    <a href="/user-super-admin/{{ $item->id }}/delete"
