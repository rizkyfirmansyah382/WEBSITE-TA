    ...
    <div class="container-fluid">
        <div class="d-sm-flex align-items-center justify-content-between text-light">
            ...
            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                <h1 class="teks-manajemen h3 mb-0" style="color: black">Data Kendaraan</h1>
            </div>
            <a href="/kendaraan-admin/create" class="btn btn-primary btn-sm mb-4">Tambah Data</a>
        </div>
                    ...
                    <tbody>
                        ...
                        @foreach ($kendaraan as $item)
                            <tr>
                                ...
                                <td>
                                    <a href="/kendaraan-admin/{{ $item->id_kendaraan }}/update"
                                        class="btn btn-warning my-1 btn-sm">
                                        <i class="far fa-edit"></i>
                                    </a>
                                    <a href="/kendaraan-admin/{{ $item->id_kendaraan }}/delete"
