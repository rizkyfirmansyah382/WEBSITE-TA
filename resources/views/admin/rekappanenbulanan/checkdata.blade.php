...
@section('content')
    <div class="container-fluid">
        ...
        <a href="/rekap-panen-bulanan/{{ $id_tanggal_panen }}" class="btn btn-primary mb-4">
                        ...
                        @foreach ($kelompokData as $key => $kelompok)
                            <tr>
                                ...
                                @for ($i = 1; $i <= 4; $i++)
                                    ...
                                    <td>
                                        @if (isset($kelompok['dates'][$i - 1]))
                                            <a href="/rekap-panen-bulanan/checkData/update/{{ $kelompok['dates'][$i - 1]['id_data_panen_kelompok'] }}/{{ $id_tanggal_panen }}/{{ $id_tanggal_panen_revisi }}"
