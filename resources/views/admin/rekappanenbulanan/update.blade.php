...
@section('content')
    <div class="container-fluid">
        ...
        <a href="{{ url()->previous() }}" class="btn btn-primary btn-sm mb-4">
            <i class="fas fa-arrow-circle-left"></i>
        </a>
        <div class="card w-100" style="background-color: #D9D9D9">
            <div class="card-body">
                <form
                    action="/rekap-panen-bulanan/checkData/updateData/{{ $tonase->id_data_panen_kelompok }}/{{ $id_tanggal_panen }}/{{ $id_tanggal_panen_revisi }}"
                    method="POST">
                    @method('put')
                    @csrf
                    <div class="mb-3">
