...
@section('content')
    <div class="container-fluid">
        ...
        <a href="/laporan-rekap-panen-bulanan" class="btn btn-primary mb-4">
                            ...
                            <tr>
                                ...
                                <td>
                                    <a class="btn btn-sm btn-primary"
                                        href="/laporan-rekap-panen-bulanan/checkData/{{ $id_tanggal_panen }}/{{ implode(',', array_column($kelompok['dates'], 'id_tanggal_panen')) }}">Check
                                        Data</a>
                                </td>
                            </tr>
                            @php
