    ...
    <div class="container-fluid">
        <div class="d-sm-flex align-items-center justify-content-between text-light">
            ...
            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                <h1 class="teks-manajemen h3 mb-0" style="color: black">Silahkan pilih bulan</h1>
            </div>
        </div>
                    ...
                    <tbody>
                        ...
                        @foreach ($kelompok as $item)
                            <tr>
                                ...
                                <td><a href="/laporan-panen-anggota-kelompok/pilih-bulan/{{ $item->id_kelompok }}"
                                        class="btn btn-primary btn-sm">Pilih Bulan</a></td>
                            </tr>
                        @endforeach
                    </tbody>
                </table>
