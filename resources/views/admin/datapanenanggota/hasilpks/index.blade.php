    ...
    <div class="container-fluid">
        <div class="d-sm-flex align-items-center justify-content-between text-light">
            ...
            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                <h1 class="teks-manajemen h3 mb-0" style="color: black">Hasil Pabrik Kelapa Sawit Harian</h1>
            </div>
        </div>
                    ...
                    <tbody>
                        ...
                        @foreach ($tanggalpanen as $item)
                            <tr>
                                ...
                                <td>
                                    <a href="/check-data-truck/{{ $item->id_tanggal_panen }}"
                                        class="btn btn-primary btn-sm">Check Data</a>
                                </td>
                            </tr>
                        @endforeach
                    </tbody>
