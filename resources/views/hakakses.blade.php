                                ...
                                <div class="col-lg-12">
                                    <div class="p-5">
                                        <div class="text-center">
                                            <div class="card mb-5">
                                                <h2 class="font-weight-bold">Silahkan Pilih Hak Akses Anda</h2>
                                            </div>
                                        </div>
                                        <center class="mb-2">
                                            <a href="/login" class="btn btn-dark">Login KUD Sawit Jaya Dan UUO</a>
                                        </center>
                                        <center>
                                            <a href="/login-kedua" class="btn btn-dark">Login Kelompok Tani Dan
                                                Mandor</a>
                                        </center>
                                        <br>
                                    </div>
