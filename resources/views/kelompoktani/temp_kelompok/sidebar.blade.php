<ul class="navbar-nav sidebar sidebar-dark accordion" id="accordionSidebar" style="background: #3A3737">
    ...
    <li class="nav-item active">
        <a class="nav-link" href="/dashboard-kelompok-tani">
    ...
    <!-- Tombol Laporan -->
    <li class="nav-item">
        <a class="nav-link" href="/tanggal-panen-kelompok">
            <i class="fas fa-tractor" style="color: white"></i>
            <span>Data Panen Kelompok</span>
        </a>
    </li>

    <li class="nav-item">
        <a class="nav-link" href="/rekap-bulanan">
    ...
    <!-- Tombol Laporan -->
    <li class="nav-item">
        <a class="nav-link" href="/daftar-anggota-baru">
