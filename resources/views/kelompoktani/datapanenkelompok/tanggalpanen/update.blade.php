...
@section('content')
    <div class="container-fluid">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-2">
            <h1 class="h3 mb-0" style="color: black">Ubah Tanggal Panen</h1>
        </div>
        ...
        <div class="card w-100" style="background-color: #D9D9D9">
            <div class="card-body">
                <form action="/tanggal-panen-kelompok/{{ $tanggal->id_tanggal_panen }}/updateData" method="POST">
                    @method('put')
                    @csrf
                    <div class="mb-3">
                        ...
                        <input type="date" class="form-control" name="tgl_panen"
                            ...
                            value="{{ date('Y-m-d', strtotime($tanggal->tgl_panen)) }}">
                        ...
                        <select class="custom-select" name="id_kelompok">
                            ...
                            @foreach ($kelompok as $item)
                                <option value="{{ $item->id_kelompok }}"
                                    {{ $tanggal->id_kelompok == $item->id_kelompok ? 'selected' : '' }}>
